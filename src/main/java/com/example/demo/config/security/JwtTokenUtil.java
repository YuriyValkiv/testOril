...
public class JwtTokenUtil implements Serializable {
    ...
    public JwtTokenUtil(TokensListService tokensListService) {
        this.tokensListService = tokensListService;
    }
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        return (username.equals(userDetails.getUsername()) && !isTokenExpired(token) && isTokenInDB(token));
    }
    ...
    private Boolean isTokenInDB(String token) {
        Optional<TokensList> optionalTokensList = tokensListService.getTokensListByToken("Bearer " + token);
        return optionalTokensList.isPresent();
    }
}
